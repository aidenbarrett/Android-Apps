...
public class ComponentDetailFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        if (savedInstanceState != null) {
            componentId = savedInstanceState.getLong("componentsId");
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            ...
            componentId = savedInstanceState.getLong("componentId");
        }
    ...
    public void onStart() {
        ...
        if (view != null) {
            ...
            Component component = Component.components[(int) componentId];
